        ...
        <div className="flex justify-between items-start mt-6">
          <div className="md:w-2/3">
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-2">
              <li>
                Memahami dasar-dasar desain, termasuk warna, simbol, dan
                tipografi
              </li>
              <li>
                Memiliki kreativitas dan ilmu-ilmu dasar untuk menggunakan
                aplikasi desain grafis
              </li>
              <li>
                Membuat logo, brosur, kartu nama, dan desain website yang
                menarik dan unik
              </li>
              <li>
                Membantu dalam bertukar informasi dan membuat informasi lebih
                menarik dan nyaman secara visual
              </li>
              <li>
                Membuat suatu informasi lebih mudah dipahami dengan menggunakan
                berbagai jenis elemen visual
              </li>
            </ul>
          </div>
